...
1)iterate starting from i = 3 to 20
2)	iterate starting from j = 2 to i-1
3)		if i is divisible by j
4)			flag = 1
5)		end if
6)	end iteration
7)	if flag is equal to 0
8)		iterate starting from k = 1 to 4
9)			if i to the power of k is less than or equal to 20
10)				num = i to the power of k
11)			end if
12)		end iteration
13)		multiply small by num, then assign it to small
14)	end if
15)	flag = 0
16)end iteration
17)display small
