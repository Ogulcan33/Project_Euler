...
iterate starting from i = 0 to 19
	iterate starting from j = 0 to 59
		If j greater than or equal to 9 Then
			Set prod_right = multiply the horizontal numbers
			If prod_right greater than largest Then
				assign prod_right to the largest
			End If
		End If			
		If i greater than or equal to 3 Then
			Set prod_up = multiply the vertical numbers
		...
		If i greater than or equal to 3 And j lesser than or equal to 48 Then
			Set prod_dia = multiply the diagonal numbers that their shape is going up and right
		...
		If i lesser than or equal to 16 And j lesser than or equal to 48 Then
			Set prod_dia2 = multiply the diagonal numbers that their shape is go down and right
