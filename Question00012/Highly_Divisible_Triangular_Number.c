...
Check if it has more than 500 divisors.  
If it does, display the number and exit the loop.
...
iterate infinite
	Declare Integer j
	assign 0 to j
	iterate starting from j to i with an increment 1
		add j to the triangle_num
	end iteration
	Declare Integer k
	assign 1 to k
	iterate starting from k to triangle_num with an increment 1
		If triangle_num Mod k is equal to 0 Then
			If triangle_num is equal to k multiplied by k Then
